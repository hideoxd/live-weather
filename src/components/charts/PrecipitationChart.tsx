...
function getBarColor(chance: number): string {
...
const PrecipitationTooltip = memo(function PrecipitationTooltip({ active, payload, label }: ChartTooltipProps) {
...
function PrecipitationChart({ data, timezone }: PrecipitationChartProps) {
